...
class JSONValidatorTool:
    ...
    description = "Validates required fields in a preauth JSON request."
...
class FHIRParserTool:
    name = "FHIRParserTool"
    description = "Parses FHIR-formatted preauthorization data into structured JSON."
